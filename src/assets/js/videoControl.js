...
(function() {
    ...
    var html_player_enhance = {
        fontSize: 14, //请输入您希望提示的文字大小(px)，默认值(浏览器默认)为 0,直接输入数字即可！
        player: function() {
